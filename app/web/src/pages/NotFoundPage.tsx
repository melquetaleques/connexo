...
export function NotFoundPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-1 px-4 font-theme-body">
      <div className="text-center max-w-lg cx-reveal">
        ...
        <div className="text-[120px] font-semibold text-primary/10 leading-none mb-4 tracking-tighter font-theme-display">
          404
        </div>
        <h1 className="text-2xl font-semibold text-ink mb-2 font-theme-display">Página não encontrada</h1>
